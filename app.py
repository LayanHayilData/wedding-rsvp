...
def set_background(image_path="background.jpg"):
    """
    Put background.jpg in the same folder as app.py.
    If the image does not exist, the app will still run with a soft gradient.
    """
    try:
        ...
        bg_css = f"""
        background-image:
            linear-gradient(rgba(255, 250, 242, 0.20), rgba(255, 250, 242, 0.20)),
    ...
    .invite-card {{
        ...
        border: 1px solid rgba(210, 182, 125, 0.55);
        border-radius: 30px;
        padding: 42px 34px;
        margin: 26px auto;
        max-width: 720px;
    ...
    .success-box {{
        background: rgba(247, 255, 247, 0.88);
...
def page_guest(token):
    ...
    <div class="main-card" dir="rtl">
        ...
        <div class="subtitle">
            بكل الفرح والسرور<br>
            نتشرف بدعوتكم لمشاركتنا فرحة عقد القران
        </div>
    </div>
    ...
    <div class="invite-card" dir="rtl">
        ...
        <div class="subtitle">
            أهلًا وسهلًا<br>
            <span class="guest-name">{name}</span><br><br>

            يسعدنا دعوتكم لحضور حفل الملكة،<br>
            ومشاركتنا هذه المناسبة السعيدة.<br><br>

            نسأل الله أن يتمم لنا على خير،<br>
            ونرجو منكم تأكيد الحضور أدناه.
        </div>
    </div>
    """, unsafe_allow_html=True)
